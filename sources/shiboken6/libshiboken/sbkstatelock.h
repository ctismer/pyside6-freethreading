...
//
// It replaced a coarse "own GIL" that was taken at wrapper entry and kept
// until the wrapper returned, so arbitrary Python, Qt and third-party code ran
...
//     lock or the coarse binding lock).
//
