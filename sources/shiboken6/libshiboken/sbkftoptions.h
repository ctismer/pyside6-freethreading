...
/// Parse the variable the way PYSIDE6_OPTION_PYTHON_ENUM is parsed: the words
/// on/off, and numbers in any of the usual bases. "0b111" is the readable
/// spelling for flags and the reason this is not a plain atoi().
LIBSHIBOKEN_API int parseOption(const char *e);
